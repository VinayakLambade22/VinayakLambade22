...
> As a BCA graduate from Tilak Maharashtra University (2025), I am passionate about building modern web applications using the MERN stack. My expertise spans both frontend and backend development, with a strong foundation in ReactJS, Node.js, and MongoDB. I'm committed to continuous learning in Data Structures & Algorithms and optimization techniques to create efficient, scalable solutions.

- **🎓 Education:** Bachelor of Computer Applications (BCA) - Tilak Maharashtra University, 2025 (GPA: 8.05/10)
- **🌱 Currently Learning:** Advanced TypeScript, System Design, and DevOps practices.
